...
In an ideal world, any process that ran in eight seconds on one machine would run in one second on eight machines. The measurement of how well a parallel program performs is called Speedup.

\[
speedup(n) = time(n)/time(1)
\]

% Measuring capabilities of parallel version
