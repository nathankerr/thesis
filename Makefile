...
# 	* Removed item: allow other comment directives for rst conversion
...
# 	* Added item: fix paper size for rst files
# 	* Added item: allow other comment directives for rst conversion
...
#	* Added a entry for epsfig support
...
# Fix paper size so that it can be specified in the file itself
