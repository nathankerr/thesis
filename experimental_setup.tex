...
evaluate. Scalability requires experimentation.
...
\begin{figure}
	\label{clusterGIS-create}
	\caption{Speedup for clusterGIS create}
	\includegraphics{clusterGIS-create.eps}
\end{figure}
...
\begin{figure}
	\label{clusterGIS-read}
	\caption{Speedup for clusterGIS read}
	\includegraphics{clusterGIS-read.eps}
\end{figure}
...
\begin{figure}
	\label{clusterGIS-update}
	\caption{Speedup for clusterGIS update}
	\includegraphics{clusterGIS-update.eps}
\end{figure}
...
\begin{figure}
	\label{clusterGIS-delete}
	\caption{Speedup for clusterGIS delete}
	\includegraphics{clusterGIS-delete.eps}
\end{figure}
...
\begin{figure}
	\label{clusterGIS-filter}
	\caption{Speedup for clusterGIS filter}
	\includegraphics{clusterGIS-filter.eps}
\end{figure}
...
\begin{figure}
	\label{clusterGIS-nearest}
	\caption{Speedup for clusterGIS nearest}
	\includegraphics{clusterGIS-nearest.eps}
\end{figure}
...
\begin{figure}
	\label{clusterGIS-chained}
	\caption{Speedup for clusterGIS chained}
	\includegraphics{clusterGIS-chained.eps}
\end{figure}
