...
TODO: Current programs can't run on a cluster. GRASS has been extended
to, but is interactive while clusters are usually batch.

The collaboration capabilities of GRASS GIS\cite{pgrass} have been used
...
Need a batch capable method (could have a graphical front-end)
