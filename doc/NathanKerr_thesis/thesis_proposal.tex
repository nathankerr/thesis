...
After the data is distributed, a user defined operation is executed. This operation should iterate over the subset of records from the primary dataset, creating a new dataset or modifying the existing one. This is also where the secondary dataset can be referenced

* split and distribute records
* iterate over records
* output new dataset

This new method will be evaluated for speedup and scaleup, using
...
new approach. Full details for datasets and operations will be given in
the thesis.
...
Evaluation of simpler data-access model simplifies software requirements thus lowers the cost to developing new models, simulations, or processing modules.
