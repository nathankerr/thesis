...
HadoopGIS doesn't get any advantage from different distribututions (other than split size)

ClusterGIS could, but doesn't now
...
\section{easy to use to form new/ad-hoc operations}
