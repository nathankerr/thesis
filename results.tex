...
% TODO: hadoop times used idealized 1core time
\begin{table}
\label{create-time}
\begin{center}
\begin{tabular}{lcc}
...
% TODO: Idealized 1core time for hadoop
\begin{table}
\label{read-time}
\begin{center}
\begin{tabular}{lcc}
...
% TODO: Used idealized 1core time for hadoop
\begin{table}
\label{filter-time}
\begin{center}
\begin{tabular}{lcc}
...
% TODO: Fix time for hadoop (used number from clovertown run)
\begin{table}
\label{chained-time}
\begin{center}
\begin{tabular}{lcc}
